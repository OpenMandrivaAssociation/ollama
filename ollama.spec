...
Source:         https://github.com/ollama/ollama/archive/refs/tags/v0.9.0-rc0/%{name}-0.9.0-rc0.tar.gz
# Generated by running, inside the source tree:
# go mod vendor
# tar cJf ../godeps-for-ollama-0.9.0.tar.xz vendor
Source1:        godeps-for-ollama-0.9.0-rc0.tar.xz
...
%prep
%autosetup -n %{name}-0.9.0-rc0 -a1 -p1
